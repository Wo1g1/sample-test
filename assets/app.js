...
var ALL_QUESTIONS = window.QUESTIONS ||  [
  ...
  {id:14, text:"마법적 기술의 상업적 이용은 가능한 한 자유롭게 허용되어야 한다.", S:1.0, effects:[{axis:'L', side:'자유', w:1.0}]},
  {id:15, text:"치안과 질서를 위해 개인의 자유를 일정 부분 양보해야 한다.", S:0.8, effects:[{axis:'L', side:'규제', w:1.0}]},
  {id:16, text:"마법은 공익을 명분으로 국가가 통제해야 한다.", S:1.0, effects:[{axis:'L', side:'규제', w:1.0}]},
  {id:17, text:"마법적 혁신은 국가의 간섭 없이 자율적으로 발전해야 한다.", S:1.0, effects:[{axis:'L', side:'자유', w:1.0}]},
  {id:18, text:"사회적 약자를 위해 공권력이 자유를 제한할 수 있다.", S:0.8, effects:[{axis:'L', side:'규제', w:1.0}]},
  {id:19, text:"세습 특권은 가능한 한 축소되어야 한다.", S:1.0, effects:[{axis:'E', side:'평등', w:1.0}]},
  {id:20, text:"신분 질서는 사회적 안정의 기초다.", S:1.0, effects:[{axis:'E', side:'권위', w:1.0}]},
  ...
  {id:28, text:"엘리트의 통치가 일반 대중의 의사보다 합리적일 때가 많다.", S:0.8, effects:[{axis:'E', side:'권위', w:1.0}]},
  {id:29, text:"산업 규제는 최소한으로 제한해야 한다.", S:1.0, effects:[{axis:'L', side:'자유', w:1.0}]},
  {id:30, text:"권리장전 보장이 평등의 기초다.", S:1.2, effects:[{axis:'E', side:'평등', w:1.0},{axis:'L', side:'자유', w:0.6}]}
